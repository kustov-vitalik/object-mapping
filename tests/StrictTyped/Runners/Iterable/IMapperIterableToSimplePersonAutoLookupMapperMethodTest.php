...
use VKPHPUtils\Mapping\Tests\StrictTyped\Mappers\Iterable\IMapperIterableToSimplePersonAutoLookupMapperMethod;
...
class IMapperIterableToSimplePersonAutoLookupMapperMethodTest extends TestCase
{
    #[Test]
    public function fromSimplePersonArrayHappyPath(): void
    {
        $mapper = Mappers::strictTyped()->getMapper(IMapperIterableToSimplePersonAutoLookupMapperMethod::class);

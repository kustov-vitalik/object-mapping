...
use VKPHPUtils\Mapping\Tests\StrictTyped\Mappers\IMapperToPersonConstructor;
...
class IMapperToPersonConstructorTest extends TestCase
{
    private IMapperToPersonConstructor $mapperToPersonConstructor;

    protected function setUp(): void
    {
        parent::setUp();
        $mapper = Mappers::strictTyped();
        $this->mapperToPersonConstructor = $mapper->getMapper(IMapperToPersonConstructor::class);
    }

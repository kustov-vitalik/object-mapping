...
#[Mapper]
abstract class MapperToPersonConstructor
{
    #[Mapping(target: 'birth', source: 'birthDate', qualifier: new Qualifier('mapDate',DateTimeMapper::class))]
    abstract public function mapFromPersonPublicProps(FromPersonPublicProps $person): ToPersonConstructor;


    #[Mapping(target: 'birth', source: 'birthDate', qualifier: new Qualifier('mapDate',DateTimeMapper::class))]
    abstract public function mapFromPersonGetters(FromPersonGetters $person): ?ToPersonConstructor;
}

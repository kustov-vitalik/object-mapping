...
#[Mapper]
interface IMapperToPersonSetters
{
    ...
    #[Mapping(target: 'birth', source: 'birthDate', qualifier: new Qualifier('mapDate',DateTimeMapper::class))]
    public function mapFromPersonPublicProps(FromPersonPublicProps $person): ToPersonSetters;


    #[Mapping(target: 'birth', source: 'birthDate', qualifier: new Qualifier('mapDate',DateTimeMapper::class))]
    public function mapFromPersonGetters(FromPersonGetters $person): ?ToPersonSetters;
}

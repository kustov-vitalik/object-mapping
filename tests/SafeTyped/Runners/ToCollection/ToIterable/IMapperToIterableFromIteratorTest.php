...
use VKPHPUtils\Mapping\Tests\SafeTyped\Mappers\ToCollection\ToIterable\IMapperToIterableFromIterator;
use VKPHPUtils\Mapping\Tests\SafeTyped\Objects\From\FromPerson;
use VKPHPUtils\Mapping\Tests\SafeTyped\Objects\To\ToPerson;

class IMapperToIterableFromIteratorTest extends TestCase
{
    #[Test]
    public function mapPeople(): void
    {
        $mapper = Mappers::safeTyped()->getMapper(IMapperToIterableFromIterator::class);

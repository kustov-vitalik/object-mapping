...
use VKPHPUtils\Mapping\Tests\SafeTyped\Mappers\ToCollection\ToGenerator\IMapperToGeneratorFromIterable;
use VKPHPUtils\Mapping\Tests\SafeTyped\Mappers\ToCollection\ToGenerator\IMapperToGeneratorFromIterator;
use VKPHPUtils\Mapping\Tests\SafeTyped\Objects\From\FromPerson;
use VKPHPUtils\Mapping\Tests\SafeTyped\Objects\To\ToPerson;

class IMapperToGeneratorFromIteratorTest extends TestCase
{
    #[Test]
    public function mapPeople(): void
    {
        $mapper = Mappers::safeTyped()->getMapper(IMapperToGeneratorFromIterator::class);

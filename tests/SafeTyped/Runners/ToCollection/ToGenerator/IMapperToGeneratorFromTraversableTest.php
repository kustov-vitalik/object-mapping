...
use VKPHPUtils\Mapping\Tests\SafeTyped\Mappers\ToCollection\ToGenerator\IMapperToGeneratorFromTraversable;
use VKPHPUtils\Mapping\Tests\SafeTyped\Objects\From\FromPerson;
use VKPHPUtils\Mapping\Tests\SafeTyped\Objects\To\ToPerson;

class IMapperToGeneratorFromTraversableTest extends TestCase
{
    #[Test]
    public function mapPeople(): void
    {
        $mapper = Mappers::safeTyped()->getMapper(IMapperToGeneratorFromTraversable::class);

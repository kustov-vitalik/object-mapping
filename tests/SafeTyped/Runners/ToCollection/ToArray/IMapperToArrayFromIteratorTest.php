...
use VKPHPUtils\Mapping\Tests\SafeTyped\Mappers\ToCollection\ToArray\IMapperToArrayFromIterator;
...
class IMapperToArrayFromIteratorTest extends TestCase
{
    #[Test]
    public function mapPeople(): void
    {
        $mapper = Mappers::safeTyped()->getMapper(IMapperToArrayFromIterator::class);

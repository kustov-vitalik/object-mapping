...
use VKPHPUtils\Mapping\Tests\SafeTyped\Mappers\ToCollection\ToArray\IMapperToArrayFromTraversable;
use VKPHPUtils\Mapping\Tests\SafeTyped\Objects\From\FromPerson;
use VKPHPUtils\Mapping\Tests\SafeTyped\Objects\To\ToPerson;

class IMapperToArrayFromTraversableTest extends TestCase
{
    #[Test]
    public function mapPeople(): void
    {
        $mapper = Mappers::safeTyped()->getMapper(IMapperToArrayFromTraversable::class);

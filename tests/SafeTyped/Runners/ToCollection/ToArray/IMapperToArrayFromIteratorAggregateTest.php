...
use VKPHPUtils\Mapping\Tests\SafeTyped\Mappers\ToCollection\ToArray\IMapperToArrayFromIterable;
use VKPHPUtils\Mapping\Tests\SafeTyped\Mappers\ToCollection\ToArray\IMapperToArrayFromIteratorAggregate;
use VKPHPUtils\Mapping\Tests\SafeTyped\Objects\From\FromPerson;
use VKPHPUtils\Mapping\Tests\SafeTyped\Objects\To\ToPerson;

class IMapperToArrayFromIteratorAggregateTest extends TestCase
{
    #[Test]
    public function mapPeople(): void
    {
        $mapper = Mappers::safeTyped()->getMapper(IMapperToArrayFromIteratorAggregate::class);

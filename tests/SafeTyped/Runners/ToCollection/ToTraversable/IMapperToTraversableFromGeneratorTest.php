...
use VKPHPUtils\Mapping\Tests\SafeTyped\Mappers\ToCollection\ToTraversable\IMapperToTraversableFromArray;
...
class IMapperToTraversableFromGeneratorTest extends TestCase
{
    #[Test]
    public function mapPeople(): void
    {
        $mapper = Mappers::safeTyped()->getMapper(IMapperToTraversableFromGenerator::class);

...
use VKPHPUtils\Mapping\Tests\SafeTyped\Mappers\ToCollection\ToTraversable\IMapperToTraversableFromIteratorAggregate;
use VKPHPUtils\Mapping\Tests\SafeTyped\Objects\From\FromPerson;
use VKPHPUtils\Mapping\Tests\SafeTyped\Objects\To\ToPerson;

class IMapperToTraversableFromIteratorAggregateTest extends TestCase
{
    #[Test]
    public function mapPeople(): void
    {
        $mapper = Mappers::safeTyped()->getMapper(IMapperToTraversableFromIteratorAggregate::class);

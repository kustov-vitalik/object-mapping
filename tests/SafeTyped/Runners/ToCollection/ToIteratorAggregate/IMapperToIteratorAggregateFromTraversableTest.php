...
use VKPHPUtils\Mapping\Tests\SafeTyped\Mappers\ToCollection\ToIteratorAggregate\IMapperToIteratorAggregateFromTraversable;
...
class IMapperToIteratorAggregateFromTraversableTest extends TestCase
{
    #[Test]
    public function mapPeople(): void
    {
        $mapper = Mappers::safeTyped()->getMapper(IMapperToIteratorAggregateFromTraversable::class);

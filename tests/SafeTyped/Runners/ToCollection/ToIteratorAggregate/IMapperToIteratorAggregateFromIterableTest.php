...
use VKPHPUtils\Mapping\Tests\SafeTyped\Mappers\ToCollection\ToIteratorAggregate\IMapperToIteratorAggregateFromIterable;
...
class IMapperToIteratorAggregateFromIterableTest extends TestCase
{
    #[Test]
    public function mapPeople(): void
    {
        $mapper = Mappers::safeTyped()->getMapper(IMapperToIteratorAggregateFromIterable::class);

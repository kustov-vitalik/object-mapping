...
use VKPHPUtils\Mapping\Tests\SafeTyped\Mappers\ToCollection\ToIteratorAggregate\IMapperToIteratorAggregateFromIteratorAggregate;
...
class IMapperToIteratorAggregateFromIteratorAggregateTest extends TestCase
{
    #[Test]
    public function mapPeople(): void
    {
        $mapper = Mappers::safeTyped()->getMapper(IMapperToIteratorAggregateFromIteratorAggregate::class);

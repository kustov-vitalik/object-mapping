...
class ToBooleanTFactory extends SingleSourceUniqueTargetTypeTFactory
{
    ...
    public function createTransformation(array $sourceTypeInfo, Type $targetType, TFactoryCtx $tFactoryCtx): ITransformation
    {
        ...
        return match (true) {
            TypeChecker::isBooleanType($sourceType) => new EmptyTransformation(),

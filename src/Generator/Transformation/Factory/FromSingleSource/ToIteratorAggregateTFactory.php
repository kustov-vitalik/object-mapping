...
use VKPHPUtils\Mapping\Generator\Transformation\ToCollection\ToIteratorAggregate\FromArrayTransformation;
use VKPHPUtils\Mapping\Generator\Transformation\ToCollection\ToIteratorAggregate\FromGeneratorTransformation;
use VKPHPUtils\Mapping\Generator\Transformation\ToCollection\ToIteratorAggregate\FromIterableTransformation;
use VKPHPUtils\Mapping\Generator\Transformation\ToCollection\ToIteratorAggregate\FromIteratorAggregateTransformation;
use VKPHPUtils\Mapping\Generator\Transformation\ToCollection\ToIteratorAggregate\FromIteratorTransformation;
use VKPHPUtils\Mapping\Generator\Transformation\ToCollection\ToIteratorAggregate\FromTraversableTransformation;
use VKPHPUtils\Mapping\Helper\TypeChecker;
use VKPHPUtils\Mapping\Reflection\ReflectionMethod;

class ToIteratorAggregateTFactory extends SingleSourceUniqueTargetTypeTFactory
{
    ...
    {
        if (!TypeChecker::isIteratorAggregateType($targetType)) {

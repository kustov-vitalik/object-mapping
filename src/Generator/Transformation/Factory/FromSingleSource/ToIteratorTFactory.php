...
use VKPHPUtils\Mapping\Generator\Transformation\ToCollection\ToIterator\FromArrayTransformation;
use VKPHPUtils\Mapping\Generator\Transformation\ToCollection\ToIterator\FromGeneratorTransformation;
use VKPHPUtils\Mapping\Generator\Transformation\ToCollection\ToIterator\FromIterableTransformation;
use VKPHPUtils\Mapping\Generator\Transformation\ToCollection\ToIterator\FromIteratorAggregateTransformation;
use VKPHPUtils\Mapping\Generator\Transformation\ToCollection\ToIterator\FromIteratorTransformation;
use VKPHPUtils\Mapping\Generator\Transformation\ToCollection\ToIterator\FromTraversableTransformation;
use VKPHPUtils\Mapping\Helper\TypeChecker;
use VKPHPUtils\Mapping\Reflection\ReflectionMethod;

class ToIteratorTFactory extends SingleSourceUniqueTargetTypeTFactory
{
    ...
    {
        if (!TypeChecker::isIteratorType($targetType)) {
